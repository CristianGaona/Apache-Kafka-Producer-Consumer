...
class Crisda24Callback implements Callback{
	public static final Logger log = LoggerFactory.getLogger(Crisda24Callback.class);
	@Override
...
public class Crisda24CallbackProducerLambda {

	public static final Logger log = LoggerFactory.getLogger(Crisda24CallbackProducerLambda.class);
